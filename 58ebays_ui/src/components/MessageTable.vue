...
<template>
  ...
  <base-input label="MessageContent" type="text" placeholder="Enter MessageContent" v-model="messageToAdd.messageContent"></base-input>
  <base-input label="SendDate" type="text" placeholder="Enter SendDate" v-model="messageToAdd.sendDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'messageContent',
          ...
          sorter: true
          //sorter: (a, b) => a.messageContent - b.messageContent,
          //sorter: (a, b) => a.messageContent.localeCompare(b.messageContent),
        },
        {
          title: 'Send Date',
		dataIndex: 'sendDate',
